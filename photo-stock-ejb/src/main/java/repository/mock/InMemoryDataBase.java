...
public final class InMemoryDataBase {
    ...
    private static Profile createProfile() {
        ...
        profile.setAvatarUrl(
                "https://devstudy-net.github.io/myphotos-com-test-images/Richard-Hendricks.jpg");
        return profile;
    }
    ...
    private static List<Photo> createPhotos(Profile profile) {
        ...
        for (int i = 1; i <= 15; i++) {
            ...
            String imageUrl = String.format(
                    "https://devstudy-net.github.io/myphotos-com-test-images/%s.jpg",
                    i % 6 + 1);
            photo.setSmallUrl(imageUrl);
            photo.setLargeUrl(
                    "https://devstudy-net.github.io/myphotos-com-test-images/large.jpg");
